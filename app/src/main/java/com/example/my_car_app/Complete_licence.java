...
public class Complete_licence extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_licence);

        completebtn = findViewById(R.id.btnlicencecomplete);
        context = this;
        ...
        completebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Module_table2 module_table5=new Module_table2(nickname,vehicale_number,"Next licence renewal date: ",
                        getNext_license_renewal_date(licence_renewal));
                dbHandler.updatetable2(module_table5);

                Module_table2 module_table6=new Module_table2(nickname,vehicale_number,"Next insurance renewal date: ",
