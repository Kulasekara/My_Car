...
public class Complete_insurance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_insurance);

        completebtn = findViewById(R.id.btnInsurancecomplete);
        context = this;
